...
module.exports = class ComponentDirector {
    ...
    installComponents(componentList) {
        ...
        return new Promise((resolve, reject) => {
            ...
            npm.load({
                ...
                npm.commands.install(packageList, function(err2, data) {
                    if (err2) reject(err2);
    ...
    initComponents(componentList) {
        ...
        return promiseSequence(componentList, (component) => {
            var newPath = path.resolve(this.config.dataDir, "node_modules", component.packageName);

            var obj = require(newPath); // eslint-disable-line global-require
